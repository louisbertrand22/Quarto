        ...
        <div className="flex items-center justify-between">
          ...
          <nav className="flex items-center space-x-4 md:space-x-6">
            {showNavigation && onHomeClick && (
              <button
                onClick={onHomeClick}
                className={`flex items-center cursor-pointer space-x-2 px-3 py-1.5 rounded-lg transition-colors ${currentView === 'game' ? 'bg-white/20 text-white' : 'text-white hover:text-indigo-100'}`}
                title={t.header.home}
              >
            ...
            {showNavigation && onStatsClick && (
              <button
                ...
                className={`flex items-center cursor-pointer space-x-2 px-3 py-1.5 rounded-lg transition-colors ${currentView === 'stats' ? 'bg-white/20 text-white' : 'text-white hover:text-indigo-100'}`}
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
